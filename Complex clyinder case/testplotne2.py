...
class TrajectoryNSNet():
    def __init__(self,B):
        ...
        self.iter = 0
        self.net_2.load_state_dict(torch.load("suanli2nopretrainnet2.pth"))
...
filename_test = "shiyan0.20611.csv"
...
# wangge_p = [i-p_min for i in wangge_p]
...
fig.savefig('2_u_mag_25_25s'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
ax.set_aspect('equal')
fig.savefig('2_error_u_mag_25_25s'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
fig.savefig('2_u_25_25s' + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
cbar.ax.tick_params(labelsize=8)  # 设置刻度标签字体大小
fig.savefig('2_v_25_25s'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
cbar.ax.tick_params(labelsize=8)  # 设置刻度标签字体大小
fig.savefig('2_p_25_25s'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
ax.set_aspect('equal')
fig.savefig('2_error_u_25_25s'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
ax.set_aspect('equal')
fig.savefig('2_error_v_25_25s'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
ax.set_aspect('equal')
fig.savefig('2_error_p_25_25s'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
df_true.to_csv('2true_velocity_kde.csv', index=False)
df_pred.to_csv('2predicted_velocity_kde.csv', index=False)
df_error.to_csv('2error_kde.csv', index=False)
