...
class TrajectoryNSNet():
    ...
    def train(self, traindata):
        ...
        print('End')
        torch.save(self.net_1.state_dict(), "suanli2nopretrainnet1.pth")
        torch.save(self.net_2.state_dict(), "suanli2nopretrainnet2.pth")
...
ax.set_xlim(0, 1)
ax.set_ylim(0, 0.2)
fig.savefig('2_all_train_particles'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
...
ax.set_xlim(0, 1)
ax.set_ylim(0, 0.2)
fig.savefig('2_all_train_velo_mag_25'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
plt.show()
