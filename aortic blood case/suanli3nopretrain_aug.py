...
class TrajectoryNSNet():
    ...
    def closure(self):
        ...
        if self.iter % 1000 == 0:
            torch.save(self.net_1.state_dict(), f"suanli3net1nopretrain_all_aug_{self.iter}.pth")
            torch.save(self.net_2.state_dict(), f"suanli3net2nopretrain_all_aug_{self.iter}.pth")
    ...
    def train(self, traindata):
        ...
        print('End')
        torch.save(self.net_1.state_dict(), "suanli3nopretrainnet1_aug.pth")
        torch.save(self.net_2.state_dict(), "suanli3nopretrainnet2_aug.pth")
...
train_data = np.load('case3_train_data.npy')
...
(x0_train_aug, y0_train_aug, t0_train_aug,
 ...
 u_net_aug, v_net_aug) = trajectory_augmentation(
    ...
    x_net, y_net, t_net,
    u_net, v_net,
    min_time_steps_list=[2, 3, 4, 5]  # 支持切片长度为2,3,4
)
