...
# Load Data
test_data = np.load('case3_test_data.npy')
x0_train = test_data[:, 0:1]
y0_train = test_data[:, 1:2]
t0_train = test_data[:, 2:3]
x_net = test_data[:, 3:4]
y_net = test_data[:, 4:5]
t_net = test_data[:, 5:6]
u_net = test_data[:, 6:7]
...
delta_index = np.load('case3_test_delta_index.npy')
