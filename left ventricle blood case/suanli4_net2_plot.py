...
train_data = addbatch(xyt0_train,xyuv_train, 30000000)
...
#####################################视频输出################################################
#
# output_video = 'output_video_v_suanli4_predict_1000it.avi'  # 输出视频文件名
# fps = 10  # 视频帧率
#
# # 获取文件夹中所有 .npz 文件
...
#     # vvv_snap = -vvv_snap
#     xxx_snap = [i + 0.0469760 for i in xxx_snap]
#     yyy_snap = [i + 0.0118951 for i in yyy_snap]
#     xxx_snap = np.array(xxx_snap).flatten()[:, None]
#     yyy_snap = np.array(yyy_snap).flatten()[:, None]
#
#     # 缩放
...
#
#     # 绘制散点图
#     sc = ax.scatter(xxx_snap, yyy_snap, c=v_pred, s=5.0, cmap='rainbow', marker="s", vmin=-0.1, vmax=0.1)
#
#     # 添加颜色条
#     cbar = plt.colorbar(sc, ax=ax)
#     # 设置坐标轴范围
...
#     ax.set_yticks([])
#     # 设置标题
#     ax.set_title(f'v t={file_number}', fontsize=20)
#     ax.set_aspect('equal')
#     # 保存图像
...
ax1.set_title('u true t=10s', fontsize = 10)
ax2.set_title('u predict t=10s', fontsize = 10)
ax1.set_xticks([])
ax1.set_yticks([])
...
# ax1.set_ylabel('$y$', size=10)
# ax2.set_ylabel('$y$', size=10)
ax1.set_title('u true t=100s', fontsize = 10)
ax2.set_title('u predict t=100s', fontsize = 10)
ax1.set_xticks([])
ax1.set_yticks([])
for spine in ax1.spines.values():
    spine.set_visible(False)
...
# ax1.set_ylabel('$y$', size=10)
# ax2.set_ylabel('$y$', size=10)
ax1.set_title('u true t=190s', fontsize = 10)
ax2.set_title('u predict t=190s', fontsize = 10)
ax1.set_xticks([])
ax1.set_yticks([])
for spine in ax1.spines.values():
    spine.set_visible(False)
...
# ax1.set_ylabel('$y$', size=10)
# ax2.set_ylabel('$y$', size=10)
ax1.set_title('u true t=120s', fontsize = 10)
ax2.set_title('u predict t=120s', fontsize = 10)
ax1.set_xticks([])
ax1.set_yticks([])
for spine in ax1.spines.values():
    spine.set_visible(False)
