...
for i in range(int(len(plot_test_index))):
    ...
    # plt.annotate(j,xy=(x0_test[index_plot[j]],y0_test[index_plot[j]]),xytext=(x0_test[index_plot[j]]+ -1 + 1 * np.random.rand(),y0_test[index_plot[j]]- 1 + 2 * np.random.rand()),arrowprops=dict(arrowstyle='->'))
...
# annotate_point(19, x_test[index_plot[19]], y_test[index_plot[19]],
#                (x_test[index_plot[19]]-0.039, y_test[index_plot[19]]+0.03))
# annotate_point(1, x_test[index_plot[1]], y_test[index_plot[1]],
#                (x_test[index_plot[1]]+0.02, y_test[index_plot[1]]+0.03))
# annotate_point(20, x_test[index_plot[20]], y_test[index_plot[20]],
#                (x_test[index_plot[20]]-0.068, y_test[index_plot[20]]+0.01))
# annotate_point(45, x_test[index_plot[45]], y_test[index_plot[45]],
#                (x_test[index_plot[45]]-0.058, y_test[index_plot[45]]-0.04))
...
# ax.set_aspect('equal')
# plt.rcParams['svg.fonttype'] = 'none'
# fig.savefig('4particle test t=100 pred'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
# plt.show()
#
# x_plot_true = []
# y_plot_true = []
...
# y_plot_pred = []
# for i in range(len(t_test)):
#     if t_test[i] == 0.005 * 190 * (U / L):
#         x_plot_true.append(x_test[i])
#         y_plot_true.append(y_test[i])
#         x_plot_pred.append(x_pred[i])
#         y_plot_pred.append(y_pred[i])
# NE_x_190 = abs(np.array(x_plot_pred) - np.array(x_plot_true)) / 1
# NE_y_190 = abs(np.array(y_plot_pred) - np.array(y_plot_true)) / 1
# np.savetxt('4NE_x_190.csv', NE_x_190, fmt='%.18f', delimiter=',', newline='\n')
# np.savetxt('4NE_y_190.csv', NE_y_190, fmt='%.18f', delimiter=',', newline='\n')
# colors = np.random.rand(len(x_plot_true),3)
# # fig = plt.figure(figsize=(9, 6), dpi=300)
# # ax = fig.add_subplot(111)
# # plt.scatter(x_plot_true,y_plot_true,s =15, marker="o",c=colors, rasterized=True)
...
# ax.set_aspect('equal')
# plt.rcParams['svg.fonttype'] = 'none'
# fig.savefig('4particle test t=190 true'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
# plt.show()
#
# fig = plt.figure(figsize=(6, 3), dpi=300)
# ax = fig.add_subplot(111)
...
# ax.set_aspect('equal')
# plt.rcParams['svg.fonttype'] = 'none'
# fig.savefig('4particle test t=190 pred'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
# plt.show()
#
# x_plot_true = []
# y_plot_true = []
...
# y_plot_pred = []
# for i in range(len(t_test)):
#     if t_test[i] == 0.005 * 120 * (U / L):
#         x_plot_true.append(x_test[i])
#         y_plot_true.append(y_test[i])
#         x_plot_pred.append(x_pred[i])
#         y_plot_pred.append(y_pred[i])
# NE_x_120 = abs(np.array(x_plot_pred) - np.array(x_plot_true)) / 1
# NE_y_120 = abs(np.array(y_plot_pred) - np.array(y_plot_true)) / 1
# np.savetxt('4NE_x_120.csv', NE_x_120, fmt='%.18f', delimiter=',', newline='\n')
# np.savetxt('4NE_y_120.csv', NE_y_120, fmt='%.18f', delimiter=',', newline='\n')
# colors = np.random.rand(len(x_plot_true),3)
# # fig = plt.figure(figsize=(9, 6), dpi=300)
# # ax = fig.add_subplot(111)
# # plt.scatter(x_plot_true,y_plot_true,s =15, marker="o",c=colors, rasterized=True)
...
# ax.set_aspect('equal')
# plt.rcParams['svg.fonttype'] = 'none'
# fig.savefig('4particle test t=120 true'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
# plt.show()
#
# fig = plt.figure(figsize=(6, 3), dpi=300)
# ax = fig.add_subplot(111)
...
# ax.set_aspect('equal')
# plt.rcParams['svg.fonttype'] = 'none'
# fig.savefig('4particle test t=120 pred'  + ".svg", bbox_inches='tight', dpi=600, pad_inches=0.1)
# plt.show()
##################################
# t_x_plot = []
...
#     t_x = delta_i * i + 999
#     t_x_plot.append(t_x)
# x_t_plot = x_net[t_x_plot,:]
# y_t_plot = y_net[t_x_plot,:]
# fig = plt.figure(figsize=(5, 5), dpi=300)
# ax = fig.add_subplot(111)
# plt.scatter(x_t_plot,y_t_plot,s =0.2, marker="^",c='r')
# ax.set_xlabel('$x$', size=20)
# ax.set_ylabel('$y$', size=20)
# ax.set_title('particle location t=1000', fontsize = 20)
# plt.axis('equal')
# plt.show()
#############测试集################
...
#
# x_test_pred, y_test_pred = model.predict_x(x0_test, y0_test, t_net_test)
...
# ax = fig.add_subplot(111)
# plt.scatter(x_net_test,y_net_test,s =0.2, marker="^",c='r',label='True')
# plt.scatter(x_test_pred,y_test_pred,s =0.2, marker="^",c='y',label='Predict')
# ax.set_xlabel('$x$', size=20)
# ax.set_ylabel('$y$', size=20)
# ax.set_title('particle test', fontsize = 20)
#
#
# plt.annotate('particle test 60',#文本内容
#          xy=(x_net_test[12000],y_net_test[12000]),#注释所在地
#          xytext=(x_net_test[12100],y_net_test[12100]), fontsize=6,#文本所在地
#          arrowprops=dict(arrowstyle="->"))
# plt.annotate('particle test 30',#文本内容
#          xy=(x_net_test[6000],y_net_test[6000]),#注释所在地
#          xytext=(x_net_test[6100],y_net_test[6100]), fontsize=6,#文本所在地
#          arrowprops=dict(arrowstyle="->"))
# plt.annotate('particle test 50',#文本内容
#          xy=(x_net_test[10000],y_net_test[10000]),#注释所在地
#          xytext=(x_net_test[10100],y_net_test[10100]), fontsize=6,#文本所在地
#          arrowprops=dict(arrowstyle="->"))
#
# plt.annotate('particle test 66',#文本内容
#          xy=(x_net_test[13200],y_net_test[13200]),#注释所在地
#          xytext=(x_net_test[13300],y_net_test[13300]), fontsize=6,#文本所在地
#          arrowprops=dict(arrowstyle="->"))
#
# plt.annotate('particle test 14',#文本内容
#          xy=(x_net_test[2800],y_net_test[2800]),#注释所在地
#          xytext=(x_net_test[2810],y_net_test[2810]), fontsize=6,#文本所在地
#          arrowprops=dict(arrowstyle="->"))
#
# plt.annotate('particle test 5',#文本内容
#          xy=(x_net_test[1000],y_net_test[1000]),#注释所在地
#          xytext=(x_net_test[1020],y_net_test[1020]), fontsize=6,#文本所在地
#          arrowprops=dict(arrowstyle="->"))
#
# plt.axis('equal')
