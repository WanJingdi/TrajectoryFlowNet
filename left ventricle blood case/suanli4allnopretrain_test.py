...
class TrajectoryNSNet():
    ...
    def closure(self):
        ...
        total_loss =  10 * loss_x +   0.0001 * loss_e +  loss_u +   0.01 * loss_f
        self.iter += 1
        if self.iter % 10 == 0:
            print(
        ...
        if self.iter == 1000:
            torch.save(self.net_1.state_dict(), "suanli4net1nopretrain_all_10x0.01f0.001e_1000it_small.pth")
            torch.save(self.net_2.state_dict(), "suanli4net2nopretrain_all_10x0.01f0.001e_1000it_small.pth")
    ...
    def train(self, traindata):
        ...
        print('End')
        # torch.save(self.net_1.state_dict(), "suanli4net1nopretrain_all_10x0.01f0.001e_1000it.pth")
        # torch.save(self.net_2.state_dict(), "suanli4net2nopretrain_all_10x0.01f0.001e_1000it.pth")
...
B_gauss_1 = np.random.randn(1000, 4)
B_gauss_1 = B_gauss_1 * 1
B_gauss_2 = np.random.randn(1000, 3)
B_gauss_2 = B_gauss_2 * 1
