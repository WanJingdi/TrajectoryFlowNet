...
# Load Data
test_data = np.load('case1_test_data.npy')
x0_test = test_data[:, 0:1]
y0_test = test_data[:, 1:2]
t0_test = test_data[:, 2:3]
x_test = test_data[:, 3:4]
y_test = test_data[:, 4:5]
t_test = test_data[:, 5:6]
u_test = test_data[:, 6:7]
v_test = test_data[:, 7:8]
p_test = test_data[:, 8:9]

L=0.998858511
U=0.969542086

delta_index = np.load('case1_test_delta_index.npy')
...
plot_test_index = np.random.choice(100, 100, replace=False)
